...
_BUILTIN_EXTENSIONS = {
    "authenticators": {
        "admin_admin": "cubes_lite.server.auth:AdminAdminAuthenticator",
        "pass_parameter": "cubes_lite.server.auth:PassParameterAuthenticator",
        "http_basic_proxy": "cubes_lite.server.auth:HTTPBasicProxyAuthenticator",
    },
    "authorizers": {
        "simple": "cubes_lite.auth:SimpleAuthorizer",
    },
    "browsers": {
        "sql":"cubes_lite.sql.browser:SQLBrowser",
        "slicer":"cubes_lite.server.browser:SlicerBrowser",
    },
    "formatters": {
        "cross_table": "cubes_lite.formatters:CrossTableFormatter",
        "csv": "cubes_lite.formatters:CSVFormatter",
        'xlsx': 'cubes_lite.formatters:XLSXFormatter',
        "html_cross_table": "cubes_lite.formatters:HTMLCrossTableFormatter",
    },
    "providers": {
        "default":"cubes_lite.model.providers:StaticModelProvider",
        "slicer":"cubes_lite.server.store:SlicerModelProvider",
    },
    "request_log_handlers": {
        "default": "cubes_lite.server.logging:DefaultRequestLogHandler",
        "csv": "cubes_lite.server.logging:CSVFileRequestLogHandler",
        'xlsx': 'cubes_lite.server.logging:XLSXFileRequestLogHandler',
        "json": "cubes_lite.server.logging:JSONRequestLogHandler",
        "sql": "cubes_lite.sql.logging:SQLRequestLogger",
    },
    "stores": {
        "sql":"cubes_lite.sql.store:SQLStore",
        "slicer":"cubes_lite.server.store:SlicerStore",
    },
}
...
class ExtensionFinder(object):
    def __init__(self, type_):
        self.type_ = type_
        self.group = "cubes_lite.{}".format(type_)
        self.extensions = {}
