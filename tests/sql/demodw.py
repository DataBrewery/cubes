...
#        {"name": "discount_price_sum", "expression": "sum(price-price*discount/100)"},
#        {"name": "discount_price", "expression": "price-price*discount/100"},

MODEL_CUBE_SALES_EXPLICIT = {
