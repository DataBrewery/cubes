...
class CubeComputationTestCase(unittest.TestCase):
    ...
    def test_combine_dimensions(self):
        ...
        results = cubes.utils.compute_dimension_cell_selectors(dims)
        # for r in results:
        #     print "=== COMBO:"
        #     for c in r:
        ...
        results = cubes.utils.compute_dimension_cell_selectors(dims, [dim])
    ...
    def test_should_not_accept_unknown_dimension(self):
        ...
        self.assertRaises(AttributeError, cubes.utils.compute_dimension_cell_selectors,
