# -*- encoding=utf -*-
"""
cubes.sql.denormalizer
~~~~~~~~~~~~~~~~~~~~~~

Star/snowflake schema denormalizer
...
class Denormalizer(object):
    """Object that denormalizes a star or snowflake schema.
    ...
    * a dictionary with keys or object with attributes: `master`, `detail`,
    ...
    def denormalized_statement(self, attributes):
        ...
        .. code-block:: python
            ...
            statement = denormalizer.denormalized_statement(attributes)
